...
ENV NEXT_PUBLIC_FRONTEND_BASE_URL=https://docgraph.up.railway.app/api/
ENV NEXT_PUBLIC_GATEWAY_URL=teal-ready-mouse-587.mypinata.cloud
ENV NEXT_PUBLIC_GOOGLE_CALLBACK_URL=https://docgraph.up.railway.app/api/auth/google/callback
ENV NEXT_PUBLIC_GOOGLE_CLIENT_ID=1023093970842-latal9j95g6tgltj8rvtllepp4e8oe3g.apps.googleusercontent.com
ENV NEXT_PUBLIC_MICROSOFT_CALLBACK_URL=https://docgraph.up.railway.app/api/auth/microsoft/callback
