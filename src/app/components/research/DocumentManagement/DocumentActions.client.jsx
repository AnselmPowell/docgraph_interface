  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="p-2 rounded-md flex flex-col items-center justify-center text-gray-600 hover:bg-gray-100 transition-colors"
      >
      ...
      >
       ...
       <button
        ...
        className={`
          w-5 h-5 ml-2 rounded border transition-colors
          ${isSelected 
