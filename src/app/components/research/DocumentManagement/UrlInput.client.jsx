...
//       // Call the handler with both the URL and FormData
...
//             <button
//               type="submit"
//               className="absolute right-3 px-2 py-1 text-xs font-medium text-white bg-blue-500 rounded hover:bg-blue-600 transition-colors"
//               disabled={isLoading}
//             >
//               Add
//             </button>
