...
const isProductionFrontend = process.env.NEXT_PUBLIC_IS_PRODUCTION_FRONTEND === 'true';
const isProductionBackend = process.env.NEXT_PUBLIC_IS_PRODUCTION_BACKEND === 'true';
...
const config = {
  ...
  microsoftRedirectUri: isProductionFrontend
    ...
    : process.env.NEXT_PUBLIC_MICROSOFT_CALLBACK_URL_DEV,
};
